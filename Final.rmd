...
After running the chi-squared test, we acquired a P-value of 0.00000000004812. After running the fisher's exact test, we acquired a P-value of 0.00000000004812. Since these are below 0.05, I reject the null hypothesis due to an extremely small p-value. The fisher exact test also states that the odds ratio is 2.1. I can observe that there is a difference in contracting covid for men who take the vaccine versus the placebo, it being beneficial.  
...
After running the chi-squared test, we acquired a P-value of 0.0011. After running the fisher's exact test, we acquired a P-value of 0.0009484. Since these are below 0.05, I reject the null hypothesis due to an extremely small p-value. The fisher exact test also states that the odds ratio is 1.4. I can observe that there is a difference in contracting covid for women who take the vaccine versus the placebo, it being beneficial. 
...
After running the chi-squared test, we acquired a P-value of 0.0000000132. After running the fisher's exact test, we acquired a P-value of 0.000000001642. Since these are below 0.05, I reject the null hypothesis due to an extremely small p-value. The fisher exact test also states that the odds ratio is 0.15. I can observe that there is a difference in contracting covid for gays who take the vaccine versus the placebo, it being harmful. 
...
After running the chi-squared test, we acquired a P-value of 0.0000001803. After running the fisher's exact test, we acquired a P-value of 0.00000002886. Since these are below 0.05, I reject the null hypothesis due to an extremely small p-value. The fisher exact test also states that the odds ratio is 0.18. I can observe that there is a difference in contracting covid for drug users who take the vaccine versus the placebo, it being harmful. 
